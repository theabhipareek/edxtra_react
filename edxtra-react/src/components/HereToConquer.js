            ...
            >
              ...
              <div className="relative flex justify-between items-center mb-6">
                <div className="flex flex-col">
                  <h3 className="font-bold text-2xl text-white">{course.title.split(' ')[0]}</h3>
                  <p className="text-gray-200 text-lg">{course.title.split(' ').slice(1).join(' ')}</p>
                </div>
              ...
              <div className="relative flex justify-between items-center">
                <button className="text-white hover:text-gray-300 font-semibold text-lg">
